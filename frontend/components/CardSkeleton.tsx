...
export const CardSkeleton: React.FC = () => {
  return (
    <div
      className="veya-web-card"
      style={{ backgroundColor: '#1E293B', minHeight: '230px' }}
    >
      <div className="card-inner">
        <div className="card-header-row">
          ...
          />
          <div className="card-identity-col" style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <div className="skeleton-box" style={{ width: '65%', height: '22px' }} />
            <div className="skeleton-box" style={{ width: '45%', height: '14px' }} />
            <div className="skeleton-box" style={{ width: '35%', height: '18px', borderRadius: '6px' }} />
          </div>
        </div>
